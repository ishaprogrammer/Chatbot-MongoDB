#pdf_services.py
from config.config import health_issues
import os
import re
import PyPDF2
from controllers.chat_service import product_cache, check_specific_health_issue, detect_health_keywords
from models.general import read_system_message, process_with_groq
from models.health_issue import process_input_with_memory
